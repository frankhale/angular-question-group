import {AfterContentInit, AfterViewInit, Component, contentChildren, input, model, output} from '@angular/core';
...
@Component({
  ...
  imports: [ReactiveFormsModule, NgForOf, NgTemplateOutlet],
